...
const amplifyAuthConfig = {
  ...
  userPoolId: 'us-east-2_CJrYNzRUD', //write your Cognito User Pool ID here
  userPoolWebClientId: '1181q9f6rle3uqibsdt87dsmee', //write your Cognito User Pool Client ID here
  oauth: {
    domain: 'us-east-2cjrynzrud.auth.us-east-2.amazoncognito.com', //write your Cognito Domain here
    scope: ['email', 'openid', 'phone'], // OAuth scopes
    redirectSignIn: 'https://main.d2e5ikjs7s989k.amplifyapp.com/admin-frontend/post-login.html', //write your Redirect Sign In URL here
    redirectSignOut: 'https://main.d2e5ikjs7s989k.amplifyapp.com/index.html', //write your Redirect Sign Out URL here
